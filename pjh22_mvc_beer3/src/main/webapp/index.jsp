...
<li><a href="<%=beerViewDir%>/beer_image.jsp">이미지 추가(C)</a>
<li><a href="<%=beerViewDir%>/beer_c2.jsp">코드자동추가(C)</a>
<li><a href="./BeerController.be?actionType=RC4">맥주칼럼정보조회(R4, MVC패턴적용)</a>
