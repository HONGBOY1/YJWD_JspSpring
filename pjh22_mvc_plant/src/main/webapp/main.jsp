	...
	<div class="hero">
		<div class="container">
			<div class="row align-items-center">
				...
				<div class="col-lg-5">
					<div class="slides">
						<img src="/image/main/1.jpg" alt="Image" class="img-fluid active">
						<img src="/image/main/2.jpg" alt="Image" class="img-fluid">
						<img src="/static/image/main/hero-slider-2.jpg" alt="Image" class="img-fluid">
						<img src="/static/image/main/3.jpg" alt="Image" class="img-fluid">
						<img src="/static/image/main/4.jpg" alt="Image" class="img-fluid">
					</div>
				</div>
			</div>
		</div>
            ...
            <div class="container">
                ...
                <div class="row g-4">
                    <div class="col-lg-4 col-md-6" data-wow-delay="0.1s" onclick="move(1)">
                        <div class="service-item rounded d-flex h-100">
                            <div class="service-img rounded">
                                <img class="img-fluid" src="/image/main/service-1.jpg" alt="">
                            </div>
                        ...
                        <div class="service-item rounded d-flex h-100">
                            ...
                            <div class="service-text rounded p-5">
                                <div class="btn-square rounded-circle mx-auto mb-3">
                                    <img class="img-fluid" src="/image/main/icon-5.png" alt="Icon">
                                </div>
                    ...
                    <div class="col-lg-4 col-md-6" data-wow-delay="0.5s" onclick="move(2)">
                        <div class="service-item rounded d-flex h-100">
                            <div class="service-img rounded">
                                <img class="img-fluid" src="../static/images/main/service-3.jpg" alt="">
                            </div>
                            <div class="service-text rounded p-5">
                                <div class="btn-square rounded-circle mx-auto mb-3">
                                    <img class="img-fluid" src="../resources/images/main/icon-6.png" alt="Icon">
                                </div>
