...
<title>Plant [·]</title>
	...
	<link rel="stylesheet" href="/CSS/plant.css" type="text/css">
...
<body>
	<header>
		...
		<nav class="navbar navbar-expand-lg lg">
		    <div class="container">
		      <a class="navbar-brand logo" href="../main">Plant[ · ]</a>
		       ...
		       <ul class="nav">
				  ...
				  <li class="nav-item">
				    <a class="nav-link boder" href="/product/list">쇼핑몰</a>
				  </li>
				  <li class="nav-item">
				...
				<ul class="nav justify-content-end">
				  <li class="nav-item">
				    <a class="nav-link active end" aria-current="page" href="../cart">장바구니</a>
				  </li>
				  <li class="nav-item">
...
<%-- 				            <li><a class="dropdown-item" href="./MemberController.be?actionType=mem_R&mem_id=<%=session.getAttribute("userid")%>">내정보</a></li> --%>
				  ...
				  <%}else { %> 
				  	  ...
				  	  <a class="nav-link end" href="/login">로그인</button></a>
				  	   <a class="nav-link end" href="/join">회원가입</button></a>
				   <%}%>
				  </li>
				</ul>
		     </div>
