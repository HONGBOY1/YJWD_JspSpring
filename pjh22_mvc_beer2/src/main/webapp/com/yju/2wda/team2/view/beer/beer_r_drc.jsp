...
<%@ page import="pjh22_mvc_beer2.model.beer.*"%>
...
<head>
<meta charset="UTF-8">
<title>>마이쇼핑몰(PJH22) - 맥주자료조회 레코드 카운트 설정(R_DRC)</title>
</head>
<body>
   <h1>마이쇼핑몰(PJH22) - 맥주자료조회 레코드 카운트 설정(R_DRC)</h1>
   <hr>
   <%
   ...
   %>
   <h2>
      DISPLAY RECORDS NUMBER: <%=limitCnt%>
   </h2>
   <hr>
